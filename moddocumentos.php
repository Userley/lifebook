...
if (!empty($_SESSION['active'])) {
    ...
    if (isset($_POST['actualizar'])) {
        ...
        $sql1 = "UPDATE documentos  SET titulo='" . $titulo . "' ,descripcion='" . $descrip . "' WHERE iddocumento='" . $iddoc . "'";
        $rs1  = mysqli_query($Cn, $sql1);

        $sql = "SELECT * from documentos where iddocumento='" . $_GET['nro'] . "'";
                                    ...
                                    <div class="col-lg-12">
                                      <div class="card">
                                        <div class="card-header d-flex align-items-center">
                                          <h3 class="h4">Modificar datos de documentos</h3>
                                        </div>
                                        <div class="card-body">
                                          ...
                                          <form class="form-horizontal" action="" method="post" >
                                            <div class="form-group row">
                                              ...
                                              <div class="col-sm-5">
                                                <input type="text" name="titulo" id="titulo" class="form-control" value="<?php echo $data[1]; ?>">
                                              </div>
                                            </div>
                                            <div class="form-group row">
                                              <label for="descrip" class="col-sm-3 form-control-label">Descripción</label>
                                              <div class="col-sm-8">
                                                <textarea class="form-control"  id="descrip" name="descripcion" aria-label="With textarea"><?php echo $data[2]; ?></textarea>
                                              </div>
                                            </div>
                                            <div class="form-group row">
                                              <label for="arch" class="col-sm-3 form-control-label">Archivo</label>
                                              <div class="col-sm-8">
                                                <label id="arch" class=" form-control-label"><?php echo $data[3]; ?></label>
                                              </div>
                                            </div>
                                         <div class="form-group row">
                                              <label for="fecha" class="col-sm-3 form-control-label">Modificación</label>
                                              <div class="col-sm-8">
                                                <label id="fecha" class=" form-control-label"><?php echo $data[5]; ?></label>
                                              </div>
                                            </div>
                                            <!--                        <div class="line"></div>-->
                                            <div class="form-group row">
