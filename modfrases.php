...
if (!empty($_SESSION['active'])) {
    ...
    if (isset($_POST['actualizar'])) {
        ...
        $sql1 = "UPDATE frases  SET autor='" . $autor . "', frase='" . $frase . "' WHERE idfrase='" . $iddoc . "'";
        $rs1  = mysqli_query($Cn, $sql1);

        $sql = "SELECT * from frases where idfrase='" . $_GET['nro'] . "'";
                                    ...
                                    <div class="col-lg-12">
                                      <div class="card">
                                        <div class="card-header d-flex align-items-center">
                                          <h3 class="h4">Modificar datos de frases</h3>
                                        </div>
                                        <div class="card-body">

                                          <form class="form-horizontal" action="" method="post" >
                                            <div class="form-group row">
                                              <label for="frase" class="col-sm-3 form-control-label">Frase</label>
                                              <div class="col-sm-8">
                                                <textarea class="form-control"  id="frase" name="frase" aria-label="With textarea"><?php echo $data[2]; ?></textarea>
                                              </div>
                                            </div>
                                            <div class="form-group row">
                                              ...
                                              <input type="text" name="autor" id="autor" class="form-control" value="<?php echo $data[1]; ?>">
                                              </div>
                                            </div>
                                         <div class="form-group row">
