      ...
      <div class="page-content d-flex align-items-stretch">
        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
            ...
            <li><a href="#personal" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-address-book-o"></i>Personal</a>
              <ul id="personal" class="collapse list-unstyled ">
              ...
              <div class="row bg-white has-shadow">
                ...
                <div class="col-xl-3 col-sm-6">
                  <div class="item d-flex align-items-center">
                    ...
                    <div class="title"><span>Documentos</span>
                      <div class="progress">
                        <div role="progressbar" style="<?php echo 'width:' . $contdocumentos . '%'; ?>; height: 4px;" aria-valuenow="<?php echo $contdocumentos; ?>" aria-valuemin="0" aria-valuemax="100" class="progress-bar bg-violet"></div>
                      </div>
                    </div>
                    <div class="number"><strong><?php echo $contdocumentos; ?></strong></div>
                  </div>
                </div>
                <!-- Item -->
                <div class="col-xl-3 col-sm-6">
                  <div class="item d-flex align-items-center">
                    ...
                    <div class="title"><span>Imágenes</span>
                      <div class="progress">
                        <div role="progressbar" style="<?php echo 'width:' . $contimagenes . '%'; ?>; height: 4px;" aria-valuenow="<?php echo $contimagenes; ?>" aria-valuemin="0" aria-valuemax="100" class="progress-bar bg-red"></div>
                      </div>
                    </div>
                    <div class="number"><strong><?php echo $contimagenes; ?></strong></div>
                  </div>
                </div>
                <!-- Item -->
                <div class="col-xl-3 col-sm-6">
                  <div class="item d-flex align-items-center">
                    ...
                    <div class="title"><span>Videos</span>
                      <div class="progress">
                        <div role="progressbar" style="<?php echo 'width:' . $contvideos . '%'; ?>; height: 4px;" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" class="progress-bar bg-green"></div>
                      </div>
                    </div>
                    <div class="number"><strong><?php echo $contvideos; ?></strong></div>
                  </div>
                </div>
                <!-- Item -->
                <div class="col-xl-3 col-sm-6">
