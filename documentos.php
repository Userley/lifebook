                              ...
                              <ul class="list-unstyled">
                                ...
                                <li><a href="#personal" aria-expanded="true" data-toggle="collapse"> <i class="fa fa-address-book-o"></i>Personal</a>
                                  <ul id="personal" class="uncollapse list-unstyled ">
                                    <li class="active"><a href="documentos.php">Documentos</a></li>
                                    ...
                                    <div class="col-lg-12">
                                      <div class="card">
                                        <div class="card-header d-flex align-items-center">
                                          <h3 class="h4">Selecciona el documento a cargar</h3>
                                        </div>
                                        <div class="card-body">

                                          <form class="form-horizontal" action="documentos.php" method="post" enctype="multipart/form-data">
...
if (isset($_POST['subir'])) {
    ...
    $destino   = "archivos/documentos/" . $nombre;

    if ($nombre != "") {
        $word   = strpos(substr($nombre, -6), ".doc");
        $wordX  = strpos(substr($nombre, -6), ".docx");
        $excel  = strpos(substr($nombre, -6), ".xls");
        $excelX = strpos(substr($nombre, -6), ".xlsx");
        $pdf    = strpos(substr($nombre, -6), ".pdf");
        $txt    = strpos(substr($nombre, -6), ".txt");

        if (($word != false) || ($wordX != false) || ($excel != false) || ($excelX != false) || ($pdf != false) || ($txt != false)) {
            # code...

            $sql = "INSERT INTO documentos (titulo,descripcion,nombre,ruta,fecha,userid) VALUES ('" . $titulo . "','" . $descrip . "','" . $nombre . "','" . $destino . "','" . $fechahora . "','" . $_SESSION['iduser'] . "')";
...
$query  = "select * from documentos where userid='" . $_SESSION['iduser'] . "'";
...
while ($Data = mysqli_fetch_array($Rslist)) {
    ...
    echo "<td>" . $Data[3] . "</td>";
    //echo "<td>" . $Data[5] . "</td>";
    echo "<td><a href='moddocumentos.php?nro=" . $Data[0] . "' class='btn btn-warning btn-sm'><i class='fa fa-pencil-square-o'></i></a> </td>";
    echo "<td><a href='elidocumentos.php?nro=" . $Data[0] . "&rta=" . $Data[4] . "' class='btn btn-danger btn-sm'><i class='fa fa-trash-o'></i></a> </td>";
    echo "<td><a href='desdocumentos.php?urldoc=" . $Data[4] . "&nom=" . $Data[3] . "' class='btn btn-success btn-sm'><i class='fa fa-download'></i></a> </td>";
    echo "</tr>";
}
