      ...
      <div class="page-content d-flex align-items-stretch">
          ...
          <ul class="list-unstyled">
            ...
            <li><a href="#personal" aria-expanded="true" data-toggle="collapse"> <i class="fa fa-address-book-o"></i>Personal</a>
              <ul id="personal" class="uncollapse list-unstyled ">
                ...
                <li class="active"><a href="imagenes.php">Imágenes</a></li>
        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Imágenes</h2>
            </div>
          </header>
          <!-- Breadcrumb-->
                                    ...
                                    <div class="col-lg-12">
                                      <div class="card">
                                        <div class="card-header d-flex align-items-center">
                                          <h3 class="h4">Selecciona imágen a cargar</h3>
                                        </div>
                                        <div class="card-body">

                                          <form class="form-horizontal" action="imagenes.php" method="post" enctype="multipart/form-data">
                                            <div class="form-group row">
                                              <label for="descrip" class="col-sm-3 form-control-label">Descripción</label>
                                              <div class="col-sm-8">
                                            ...
                                            <div class="form-group row">
                                              <label for="fileInput" class="col-sm-3 form-control-label">Cargar</label>
                                              <div class="col-sm-9">
                                                <input id="fileInput" name="archivo" type="file" class="form-control-file">
                                              </div>
                                            </div>
                                            <!--                        <div class="line"></div>-->
                                            <div class="form-group row">
...
if (isset($_POST['subir'])) {
    ...
    $destino   = "archivos/imagenes/" . $nombre;

    if ($nombre != "") {
        $jpg  = strpos(substr($nombre, -6), ".jpg");
        $jpeg = strpos(substr($nombre, -6), ".jpeg");
        $bmp  = strpos(substr($nombre, -6), ".bmp");
        $png  = strpos(substr($nombre, -6), ".png");
        $gif  = strpos(substr($nombre, -6), ".gif");
        $tif  = strpos(substr($nombre, -6), ".tif");
        $tiif = strpos(substr($nombre, -6), ".tiif");

        if (($jpg != false) || ($jpeg != false) || ($bmp != false) || ($png != false) || ($gif != false) || ($tif != false) || ($tiif != false)) {
            # code...

            $sql = "INSERT INTO imagenes (descripcion,nombre,ruta,fecha,userid) VALUES ('" . $descrip . "','" . $nombre . "','" . $destino . "','" . $fechahora . "','" . $_SESSION['iduser'] . "')";
            $rs  = mysqli_query($Cn, $sql);

            if ($rs) {
                echo "<script type='text/javascript'>
                                                    swal('¡Archivo almacenado correctamente!','','success');
                                                    </script>";
            ...
            echo "<script type='text/javascript'>
                                                  swal('¡Archivo Incorrecto!','','error');
                                                  </script>";
        }
    } else {
        echo "<script type='text/javascript'>
                                                swal('Seleccione archivo','','warning');
                                                </script>";
    }
}
?>
                                            ...
                                            <div class="col-lg-12">
                                              ...
                                              <div class="col-sm-10">
                                                <input class="form-control border border-info" id="buscar" type="text" placeholder="Buscar imágen...">
                                              </div>
                                            </div>
...
$query  = "select * from imagenes where userid='" . $_SESSION['iduser'] . "'";
...
while ($Data = mysqli_fetch_array($Rslist)) {
    ...
    //echo "<td>" . $Data[3] . "</td>";
    //echo "<td>" . $Data[5] . "</td>";
    echo "<td ><a id='foto" . $Data[0] . "' class='btn btn-primary btn-sm'><i class='fa fa-eye'></i></a> </td>";
    echo " <script> $('#foto'+" . $Data[0] . ").click(function(){
Swal.fire({
  imageUrl: 'http://lifebook.eshost.com.ar/" . $Data[3] . "',
  imageHeight: 320,
  imageAlt: '" . $Data[2] . "'
})
});</script>";

    echo "<td><a href='modimagenes.php?nro=" . $Data[0] . "' class='btn btn-warning btn-sm'><i class='fa fa-pencil-square-o'></i></a> </td>";
    echo "<td><a href='eliimagenes.php?nro=" . $Data[0] . "&rta=" . $Data[3] . "' class='btn btn-danger btn-sm'><i class='fa fa-trash-o'></i></a> </td>";
    echo "<td><a href='desimagenes.php?urlimg=" . $Data[3] . "&nom=" . $Data[2] . "' class='btn btn-success btn-sm'><i class='fa fa-download'></i></a> </td>";
    echo "</tr>";
}
