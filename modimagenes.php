...
if (!empty($_SESSION['active'])) {
    ...
    if (isset($_POST['actualizar'])) {
        ...
        $sql1 = "UPDATE imagenes  SET descripcion='" . $descrip . "' WHERE idimagen='" . $iddoc . "'";
        $rs1  = mysqli_query($Cn, $sql1);

        $sql = "SELECT * from imagenes where idimagen='" . $_GET['nro'] . "'";
                                    ...
                                    <div class="col-lg-12">
                                      <div class="card">
                                        <div class="card-header d-flex align-items-center">
                                          <h3 class="h4">Modificar datos de imágenes</h3>
                                        </div>
                                        <div class="card-body">
                                          ...
                                          <form class="form-horizontal" action="" method="post" >
                                            <div class="form-group row">
                                              ...
                                              <div class="col-sm-8">
                                                <textarea class="form-control"  id="descrip" name="descripcion" aria-label="With textarea"><?php echo $data[1]; ?></textarea>
                                              </div>
                                            </div>
                                            <div class="form-group row">
